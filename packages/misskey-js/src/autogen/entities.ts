...
export type AdminApplicationsApproveRequest = operations['admin___applications___approve']['requestBody']['content']['application/json'];
export type AdminApplicationsApproveResponse = operations['admin___applications___approve']['responses']['200']['content']['application/json'];
export type AdminApplicationsListRequest = operations['admin___applications___list']['requestBody']['content']['application/json'];
export type AdminApplicationsListResponse = operations['admin___applications___list']['responses']['200']['content']['application/json'];
export type AdminApplicationsRejectRequest = operations['admin___applications___reject']['requestBody']['content']['application/json'];
export type AdminApplicationsRejectResponse = operations['admin___applications___reject']['responses']['200']['content']['application/json'];
...
export type NotesMutualTimelineRequest = operations['notes___mutual-timeline']['requestBody']['content']['application/json'];
export type NotesMutualTimelineResponse = operations['notes___mutual-timeline']['responses']['200']['content']['application/json'];
