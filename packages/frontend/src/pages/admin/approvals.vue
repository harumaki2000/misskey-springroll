	...
	<div class="_spacer" style="--MI_SPACER-w: 800px;">
		<div class="_gaps_m">
			<div :class="$style.inputs">
				<MkSelect v-model="state" :class="$style.input">
...
import MkUserApplication from '@/components/MkUserApplication.vue'; // 後で作成
import { definePage } from '@/page.js';
import { Paginator } from '@/utility/paginator.js';
import type { UserApplication } from '@/misskey-js-entities.js'; // 後で作成
