...
const onlyOnOrOffNotificationTypes = ['app', 'achievementEarned', 'login', 'createToken', 'scheduledNotePosted', 'scheduledNotePostFailed', 'unfollow', 'blocked'] satisfies (typeof notificationTypes[number])[] as string[];
